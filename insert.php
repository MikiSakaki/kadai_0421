...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_kadai0421_table(name,age,prefectures,months,day,room,facility,childcare,customerservice,food,satisfaction,comment,indate)VALUES(:name,:age,:prefectures,:months,:day,:room,:facility,:childcare,:customerservice,:food,:satisfaction,:comment,sysdate())");
